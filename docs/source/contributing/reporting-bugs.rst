...
`Issues <https://github.com/pymovements/pymovements/issues>`_ to see if this bug has already been
reported.

In case the bug has not been reported yet, please do the following:

- `Open an issue <https://github.com/pymovements/pymovements/issues/new?labels=bug&template=ISSUE.md>`_.
